...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Star star2 = new Star(prenom: "Le pape", nom:"François", urlPhoto:"http://www.la-croix.com/var/bayard/storage/images/lacroix/religion/actualite/le-cardinal-jorge-mario-bergoglio-est-le-pape-francois-_ng_-2013-03-13-920733/30146632-9-fre-FR/Le-cardinal-Jorge-Mario-Bergoglio-est-le-pape-Francois_article_main.jpg").save()
